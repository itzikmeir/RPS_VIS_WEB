...
function renderInfoPage(root, pageId) {
  ...
  if (pageId === "experiment_flow") {
    ...
    [
      ...
      "אם יש 2 דרישות במטלה כגון: נוף וחסכון, יש לבחור מסלול שבהכרח יענה על שתיהן והוא לאו דווקא הכי קצר.",
    ].forEach(function(t) {
      const li = document.createElement("li");
      li.textContent = t;
      li.style.marginBottom = "4px";
